              ...
              <tr>
                ...
                <td class="text-center">
                  <div class="btn-group">
                    ...
                    <?php if($lic['activo'] === 'Activo'): ?>
                      <a href="delete_licenciatura.php?id=<?php echo $lic['claveLic'];?>&activo=Inactivar" class="btn btn-warning btn-xs"  title="Inactivar" data-toggle="tooltip"><span class="glyphicon glyphicon-trash"></span></a>
                    <?php else: ?>
                      <a href="delete_licenciatura.php?id=<?php echo $lic['claveLic'];?>&activo=Activo" class="btn btn-success btn-xs"  title="Activar" data-toggle="tooltip"><span class="glyphicon glyphicon-ok"></span></a>
                    <?php endif;?>
                  </div>
                </td>
              </tr>
