...
?>
<?php
/////////////////////////////////////////////////////////////////////////////////modificar los usuarios para el control de datos en la URL
      ...
      <div class="panel-body">
          <form method="post" action="edit_account.php?id=<?php echo (int)$user['id'];?>" class="clearfix">
            ...
            <!--<div class="form-group">
                  ...
                  <input enable type="text" class="form-control" name="username" value="<?php //echo remove_junk(ucwords($user['username'])); ?>">
            </div>-->
            <div class="form-group clearfix">
                    <a href="change_password.php?cl=<?php echo $_GET['cl'];?>" title="change password" class="btn btn-danger pull-right">Cambiar contraseña</a>
